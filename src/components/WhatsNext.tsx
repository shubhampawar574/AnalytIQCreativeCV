  ...
  return (
    <section id="whats-next" className="py-24 bg-slate-950 relative border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-slate-900 via-emerald-950/80 to-slate-900 border border-emerald-500/40 text-center space-y-6 shadow-2xl relative overflow-hidden flex flex-col items-center">
          <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-emerald-400/80 shadow-xl">
            <img
          ...
          <div className="space-y-2 max-w-2xl mx-auto">
            ...
            <p className="text-xs sm:text-sm text-slate-300">
              Shubham Pawar is open for discussions regarding full-time management, analytics, consulting, and product strategy opportunities.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <a
              ...
              className="flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700 font-bold text-xs sm:text-sm transition-all hover:scale-105"
            >
              <span>Phone: {PERSONAL_INFO.contact}</span>
            </a>
