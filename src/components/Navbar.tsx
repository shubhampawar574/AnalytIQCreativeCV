      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        {isSubPage ? (
          ...
          <a href="#hero" className="flex items-center gap-3 group">
            <div className="relative w-10 h-10 rounded-xl overflow-hidden border-2 border-emerald-500/50 shadow-md shadow-emerald-500/20 group-hover:scale-105 transition-transform shrink-0">
              <img
